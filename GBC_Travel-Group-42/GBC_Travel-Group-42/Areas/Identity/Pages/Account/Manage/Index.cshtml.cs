...
namespace GBC_Travel_Group_42.Areas.Identity.Pages.Account.Manage
{
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (user.UsernameChangeLimit > 0)
            {
                if (Input.Username != user.UserName)
                {
                    ...
                    {
                        StatusMessage = "Error: An unexpected error has occured when attempting to update username.";
                        return RedirectToPage();
                    }
                    else
                    {
